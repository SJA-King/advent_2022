...
def part_1():
    ...
    top_of_stacks = ""
    for x in range(len(crate_stacks)):
        y = str(x + 1)
...
def part_2():
    ...
    for line in data:
        ...
        if got_start_state:
            ...
            crate_stacks[to_stack] += crate_stacks[from_stack][-int(crates_to_move):]
            crate_stacks[from_stack] = crate_stacks[from_stack][:-int(crates_to_move)]
